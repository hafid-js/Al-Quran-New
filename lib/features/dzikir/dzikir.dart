                      ...
                      children: [
                        SingleChildScrollView(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 6),
                            _dzikirButton("La ilaha illallah", laillahailallah, 3),
                             const SizedBox(width: 6),
                            _dzikirButton("Astaghfirullahal adzim", astaghfirullah, 4),
                             const SizedBox(width: 6),
                            _dzikirButton("Allahuma sholli ala Muhammad", allahumasholialamuhammad, 5),
                          ],
                        ),
                        ),
      ...
      children: [
        Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 15),
                          GestureDetector(
                            onTap: endTasbih <= freeTasbih ? null : () {
                              setState(() {
                                endTasbihDecrement();
                              });
                            },
                          ...
                          Container(
                              ...
                              child: Center(
                                child: Text("$endTasbih", style: TextStyle( fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold),),
                              )
                            ),
                          SizedBox(width: 15),
                          GestureDetector(
        ...
        Center(
          child: CircularPercentIndicator(
            ...
            radius: 130.0,
            lineWidth: 8.0,
            percent: freeTasbih == 0 ? 0 : (freeTasbih / endTasbih).clamp(0.0, 1.0),
            ...
            center: Material(
              ...
              child: InkWell(
                onTap: freeTasbih >= endTasbih ? null : () {
                  setState(() {
               tasbihCounter();
                  });
                },
  ...
  Widget _dzikirButton(String title, int counter, int index) {
    ...
    return GestureDetector(
        ...
        child: Container(
          ...
          decoration: count >= 33 ? BoxDecoration(
            color: HexColor.fromHex("#2cc4b6").withAlpha(40),
            borderRadius: BorderRadius.circular(10),
            border: BoxBorder.all(color: HexColor.fromHex("#2cc4b6"), width: 0.5)
          )
          : BoxDecoration(
            color: isActive ? HexColor.fromHex("#2cc4b6") : HexColor.fromHex("#132e3a"),
            borderRadius: BorderRadius.circular(10),
          ),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Row(
                          children: [
                            count >= 33 ? Icon(Icons.check_circle_rounded, size: 16, color: HexColor.fromHex("#2cc4b6")): SizedBox.shrink(),
                          count >= 33 ? SizedBox(width: 5) : SizedBox.shrink(),
                            Text(
                          title,
                          style:
                          count >= 33 ? TextStyle(fontSize: 12, color:  HexColor.fromHex("#2cc4b6") , fontWeight: FontWeight.w500) :
                          TextStyle(fontSize: 12, color: isActive ? Colors.white : HexColor.fromHex("#7c97a6") , fontWeight: FontWeight.w500),
                        ),
                          ],
                        ),
                        SizedBox(width: 5),
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 11,
                            color: count >= 33 ? HexColor.fromHex("#7c97a6") : isActive ? Colors.white : HexColor.fromHex("#7c97a6"),
