                ...
                itemBuilder: (context, index) {
                  ...
                  return Column(
                    children: [
                      ...
                      SizedBox(height: Responsive.boxSize(context, phone: 10)),
                    ],
                  );
                },
              ),
              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () => Get.back(),
                    child: Container(
                      height: Responsive.boxSize(context, phone: 40),
                      width: Responsive.boxSize(context, phone: 40),
                      decoration: BoxDecoration(
                      ...
                      child: Icon(
                        Icons.arrow_circle_left_rounded,
                        color: Colors.white,
                        size: Responsive.iconSize(context, phone: 22),
                      ),
                    ),
                  ),
                  GestureDetector(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          SettingsSlider(
                                            ...
                                            onChanged: (value) {
                                              modalSetState(() {
                                                controller.ukuranTeksArab.value = value;
                                              });
                                            },
                                          ),
                                          const SizedBox(height: 5),
                                          SettingsSlider(
                                            ...
                                            onChanged: (value) {
                                              modalSetState(() {
                                                controller.ukuranLatinTerjemah.value = value;
                                              });
                                            },
                                          ),
                                          const SizedBox(height: 5),
                                          SettingsSwitchTile(
                                            ...
                                            onChanged: (value) {
                                              modalSetState(() {
                                                controller.arabBold.value = value;
                                              });
                                            },
                                          ),
                                          const SizedBox(height: 5),
                                          ...
                                          SettingsSwitchTile(
                                            ...
                                            onChanged: (value) {
                                              modalSetState(() {
                                                controller.terjemah.value = value;
                                              });
                                            },
                                          ),
                                        ],
