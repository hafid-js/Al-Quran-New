...
void _locationCacheSerialize(
  ...
  writer.writeString(offsets[1], object.province);
...
LocationCache _locationCacheDeserialize(
  ...
  object.id = id;
  object.province = reader.readString(offsets[1]);
...
extension LocationCacheQuerySortBy
  ...
  QueryBuilder<LocationCache, LocationCache, QAfterSortBy> sortByProvince() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocationCache, LocationCache, QAfterSortBy> sortByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationCacheQuerySortThenBy
  ...
  QueryBuilder<LocationCache, LocationCache, QAfterSortBy> thenByProvince() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'province', Sort.asc);
    });
  }
  ...
  QueryBuilder<LocationCache, LocationCache, QAfterSortBy> thenByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updatedAt', Sort.asc);
    });
  }
...
extension LocationCacheQueryWhereDistinct
  ...
  QueryBuilder<LocationCache, LocationCache, QDistinct> distinctByProvince(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<LocationCache, LocationCache, QDistinct> distinctByUpdatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationCacheQueryProperty
  ...
  QueryBuilder<LocationCache, String, QQueryOperations> provinceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'province');
    });
  }

  QueryBuilder<LocationCache, DateTime, QQueryOperations> updatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
