...
class AllIconIslamic extends StatefulWidget {
  const AllIconIslamic({super.key});

  @override
  State<AllIconIslamic> createState() => _AllIconIslamicState();
}

class _AllIconIslamicState extends State<AllIconIslamic> {
