...
import 'package:alquran_new/development/hizb_cache_datasource.dart';
import 'package:alquran_new/development/hizb_range.dart';
...
class HizbController extends GetxController {
  ...
  final _cacheDatasource = HizbCacheDatasource();

  var isLoading = false.obs;
  var hizbAyatList = <JuzAyat>[].obs;
  ...
  Future<void> fetchHizb(int hizbNumber) async {
    ...
    final range = hizbRanges[hizbNumber - 1];
    ...
    hizbAyatList.value = result;
    isLoading.value = false;

    if (result.isNotEmpty) {
      await _cacheDatasource.saveHizb(hizbNumber, result);
    }
  }
