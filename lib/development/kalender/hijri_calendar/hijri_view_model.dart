import 'package:alquran_new/development/kalender/data/events_data.dart';
            ...
            !isHijriView
              ...
              style:
                  ...
                  : style?.copyWith(
                      ...
                      color: !isCurrentMonthDays
                          ? (isDisablePreviousNextMonthDates
                                ? defaultTextColor.withValues(alpha: 0.4)
                                : defaultTextColor)
                          : (isEventDay && isCurrentMonthDays) ? Colors.white : hijriDefaultTextColor,
                    ),
            ),
