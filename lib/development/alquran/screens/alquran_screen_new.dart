...
import 'package:alquran_new/development/alquran/screens/detail_surah_screen.dart';
...
final List<HizbData> hizbList = [
  ...
  HizbData(
    number: 49,
    startPage: 486,
    startSurah: "Al-Mujadalah",
    startAyah: 1,
    endSurah: "Al-Mumtahanah",
    endAyah: 13,
  ),
  HizbData(
    number: 50,
    startPage: 496,
    startSurah: "Al-Mumtahanah",
    startAyah: 14,
    endSurah: "At-Tahrim",
    endAyah: 8,
  ),
  ...
  HizbData(
    ...
    startSurah: "Al-Jinn",
    startAyah: 29,
    endSurah: "Al-Muzzammil",
    endAyah: 20,
  ),
  HizbData(
    number: 56,
    startPage: 558,
    startSurah: "Al-Muddatstsir",
    startAyah: 1,
    endSurah: "Al-Qiyamah",
    endAyah: 40,
  ),
...
final List<JuzData> juzList = [
  ...
  JuzData(
    ...
    startSurah: "An-Naba'",
    startAyah: 1,
    endSurah: "Az-Zalzalah",
    endAyah: 8,
  ),
  JuzData(
    number: 30,
    startPage: 582,
    startSurah: "Al-'Adiyat",
    startAyah: 1,
    endSurah: "An-Nas",
    endAyah: 6,
  ),
