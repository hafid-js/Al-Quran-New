...
class LocationService {
  ...
  static Future<List<String>> getCities(String province) async {
    ...
    await DevHiveService.locationBox.clear();
    await DevHiveService.locationBox.add(data);
  }

  static Future<LocationCache?> getLocation() async {
    return DevHiveService.locationBox.values.firstOrNull;
  }
...
final detectedCity =
  ...
  await DevHiveService.locationBox.clear();
  await DevHiveService.locationBox.add(cache);
